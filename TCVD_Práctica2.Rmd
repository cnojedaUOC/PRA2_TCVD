...
breast_data_def <- breast_data[c(3:32)]
...
p.mat <- cor.mtest(breast_data_def)
```

```{r}
if (!require('ggcorrplot')) install.packages('ggcorrplot'); library('ggcorrplot')

M <- cor(breast_data_def)
...
Finalmente, el conjunto de datos tendrá 23 atributos sobre los que se hará el análisis posterior.
